  ...
  return (
    <div className="card" style={{ padding: 28 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
        <div style={{ width: 38, height: 38, borderRadius: 12, background: "linear-gradient(135deg,var(--accent),var(--accent-2))", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <motion.div key={m._id} initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }}
                  ...
                  {m.user?.avatar ? (
                    ...
                    <div style={{
                      ...
                      background: m.status === "invited" ? "var(--surface-3)" : "linear-gradient(135deg,var(--accent),var(--accent-2))",
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 13, fontWeight: 600, color: "var(--text)", display: "flex", alignItems: "center", gap: 6 }}>
                      ...
                      {isMe && <span style={{ fontSize: 10, fontWeight: 700, color: "var(--accent)", background: "rgba(0,0,0,0.08)", padding: "1px 6px", borderRadius: 20 }}>You</span>}
                    </div>
