    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
        {[
          ...
          { label: "With Email", val: contacts.filter(c => c.email).length, color: "#E23744" },
        ...
        {selected.size > 0 && (
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }}
            style={{
              ...
              background: "linear-gradient(135deg, rgba(226,55,68,0.15), rgba(139,92,246,0.15))",
            ...
            return (
              <motion.div key={c._id} initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                ...
                style={{
                  ...
                  background: selected.has(c._id) ? "rgba(226,55,68,0.06)" : i % 2 ? "var(--surface-2)" : "transparent",
